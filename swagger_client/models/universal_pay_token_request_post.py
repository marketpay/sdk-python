...
class UniversalPayTokenRequestPost(object):
    ...
    def __init__(self, authorization_funds=None, tag=None, credited_wallet_id=None, secure_mode=None, success_url=None, cancel_url=None, language=None, customer=None):
        ...
        self._authorization_funds = None
        self._tag = None
        ...
        if authorization_funds is not None:
          self.authorization_funds = authorization_funds
        if tag is not None:
          self.tag = tag
    ...
    def authorization_funds(self):
        ...
        Amount that will be charged to authorize the card. Default value is 1 euro. Authorizations with zero amount may be rejected by the credit card issuer and are not guaranteed to succeed.
