...
class UserLegalPost(object):
    ...
    def headquarters_address(self):
        """
        Gets the headquarters_address of this UserLegalPost.
        he address of the company’s headquarters

        :return: The headquarters_address of this UserLegalPost.
        :rtype: Address
        """
    ...
    def headquarters_address(self, headquarters_address):
        ...
        :param headquarters_address: The headquarters_address of this UserLegalPost.
        :type: Address
        """
    ...
    def legal_person_type(self):
        """
        Gets the legal_person_type of this UserLegalPost.
        The type of legal user

        :return: The legal_person_type of this UserLegalPost.
        :rtype: str
        """
    ...
    def legal_person_type(self, legal_person_type):
        ...
        :param legal_person_type: The legal_person_type of this UserLegalPost.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this UserLegalPost.
        The name of the legal user

        :return: The name of this UserLegalPost.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this UserLegalPost.
        :type: str
        """
    ...
    def legal_representative_address(self):
        """
        Gets the legal_representative_address of this UserLegalPost.
        The address of the company’s Legal representative person

        :return: The legal_representative_address of this UserLegalPost.
        :rtype: Address
        """
    ...
    def legal_representative_address(self, legal_representative_address):
        ...
        :param legal_representative_address: The legal_representative_address of this UserLegalPost.
        :type: Address
        """
    ...
    def legal_representative_birthday(self):
        """
        Gets the legal_representative_birthday of this UserLegalPost.
        ...
        :return: The legal_representative_birthday of this UserLegalPost.
        :rtype: int
        """
    ...
    def legal_representative_birthday(self, legal_representative_birthday):
        ...
        :param legal_representative_birthday: The legal_representative_birthday of this UserLegalPost.
        :type: int
        """
    ...
    def legal_representative_country_of_residence(self):
        """
        Gets the legal_representative_country_of_residence of this UserLegalPost.
        The country of residence of the company’s Legal representative person

        :return: The legal_representative_country_of_residence of this UserLegalPost.
        :rtype: str
        """
    ...
    def legal_representative_country_of_residence(self, legal_representative_country_of_residence):
        ...
        :param legal_representative_country_of_residence: The legal_representative_country_of_residence of this UserLegalPost.
        :type: str
        """
    ...
    def legal_representative_nationality(self):
        """
        Gets the legal_representative_nationality of this UserLegalPost.
        The nationality of the company’s Legal representative person

        :return: The legal_representative_nationality of this UserLegalPost.
        :rtype: str
        """
    ...
    def legal_representative_nationality(self, legal_representative_nationality):
        ...
        :param legal_representative_nationality: The legal_representative_nationality of this UserLegalPost.
        :type: str
        """
        allowed_values = ["NotSpecified", "AD", "AE", "AF", "AG", "AI", "AL", "AM", "AO", "AQ", "AR", "AS", "AT", "AU", "AW", "AX", "AZ", "BA", "BB", "BD", "BE", "BF", "BG", "BH", "BI", "BJ", "BL", "BM", "BN", "BO", "BQ", "BR", "BS", "BT", "BV", "BW", "BY", "BZ", "CA", "CC", "CD", "CF", "CG", "CH", "CI", "CK", "CL", "CM", "CN", "CO", "CR", "CU", "CV", "CW", "CX", "CY", "CZ", "DE", "DJ", "DK", "DM", "DO", "DZ", "EC", "EE", "EG", "EH", "ER", "ES", "ET", "FI", "FJ", "FK", "FM", "FO", "FR", "GA", "GB", "GD", "GE", "GF", "GG", "GH", "GI", "GL", "GM", "GN", "GP", "GQ", "GR", "GS", "GT", "GU", "GW", "GY", "HK", "HM", "HN", "HR", "HT", "HU", "ID", "IE", "IL", "IM", "IN", "IO", "IQ", "IR", "IS", "IT", "JE", "JM", "JO", "JP", "KE", "KG", "KH", "KI", "KM", "KN", "KP", "KR", "KW", "KY", "KZ", "LA", "LB", "LC", "LI", "LK", "LR", "LS", "LT", "LU", "LV", "LY", "MA", "MC", "MD", "ME", "MF", "MG", "MH", "MK", "ML", "MM", "MN", "MO", "MP", "MQ", "MR", "MS", "MT", "MU", "MV", "MW", "MX", "MY", "MZ", "NA", "NC", "NE", "NF", "NG", "NI", "NL", "NO", "NP", "NR", "NU", "NZ", "OM", "PA", "PE", "PF", "PG", "PH", "PK", "PL", "PM", "PN", "PR", "PS", "PT", "PW", "PY", "QA", "RE", "RO", "RS", "RU", "RW", "SA", "SB", "SC", "SD", "SE", "SG", "SH", "SI", "SJ", "SK", "SL", "SM", "SN", "SO", "SR", "SS", "ST", "SV", "SX", "SY", "SZ", "TC", "TD", "TF", "TG", "TH", "TJ", "TK", "TL", "TM", "TN", "TO", "TR", "TT", "TV", "TW", "TZ", "UA", "UG", "UM", "US", "UY", "UZ", "VA", "VC", "VE", "VG", "VI", "VN", "VU", "WF", "WS", "YE", "YT", "ZA", "ZM", "ZW"]
    ...
    def legal_representative_email(self):
        """
        Gets the legal_representative_email of this UserLegalPost.
        The email of the company’s Legal representative person - must be a valid

        :return: The legal_representative_email of this UserLegalPost.
        :rtype: str
        """
    ...
    def legal_representative_email(self, legal_representative_email):
        ...
        :param legal_representative_email: The legal_representative_email of this UserLegalPost.
        :type: str
        """
    ...
    def legal_representative_first_name(self):
        """
        Gets the legal_representative_first_name of this UserLegalPost.
        The firstname of the company’s Legal representative person

        :return: The legal_representative_first_name of this UserLegalPost.
        :rtype: str
        """
    ...
    def legal_representative_first_name(self, legal_representative_first_name):
        ...
        :param legal_representative_first_name: The legal_representative_first_name of this UserLegalPost.
        :type: str
        """
    ...
    def legal_representative_last_name(self):
        """
        Gets the legal_representative_last_name of this UserLegalPost.
        The lastname of the company’s Legal representative person

        :return: The legal_representative_last_name of this UserLegalPost.
        :rtype: str
        """
    ...
    def legal_representative_last_name(self, legal_representative_last_name):
        ...
        :param legal_representative_last_name: The legal_representative_last_name of this UserLegalPost.
        :type: str
        """
    ...
    def tag(self):
        """
        Gets the tag of this UserLegalPost.
        Custom data that you can add to this item

        :return: The tag of this UserLegalPost.
        :rtype: str
        """
        return self._tag
    ...
    def tag(self, tag):
        ...
        :param tag: The tag of this UserLegalPost.
        :type: str
        """
    ...
    def email(self):
        """
        Gets the email of this UserLegalPost.
        The user's email address - must be a valid email

        :return: The email of this UserLegalPost.
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """
        Sets the email of this UserLegalPost.
        The user's email address - must be a valid email

        :param email: The email of this UserLegalPost.
        :type: str
        """
