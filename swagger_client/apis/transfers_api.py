...
class TransfersApi(object):
    ...
    def transfers_get_list(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.transfers_get_list(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.transfers_get_list_with_http_info(**kwargs)
        else:
            (data) = self.transfers_get_list_with_http_info(**kwargs)
            return data
    ...
    def transfers_get_list_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.transfers_get_list_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ResponseListTransferResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
