...
class PayOutsBankwireApi(object):
    ...
    def pay_outs_bankwire_post(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pay_outs_bankwire_post(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.pay_outs_bankwire_post_with_http_info(**kwargs)
        else:
            (data) = self.pay_outs_bankwire_post_with_http_info(**kwargs)
            return data
    ...
    def pay_outs_bankwire_post_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.pay_outs_bankwire_post_with_http_info(callback=callback_function)
